...
public class JwtnewController {
 ...
 @CrossOrigin(origins ="https://collegecoursemanagement.netlify.app/")
	...
	// public ResponseEntity<Semesters> assignteacehers(@RequestBody Semesters
	// teachers ){
	//
	//
	// return ResponseEntity.ok().body(teachers);
	// }
	// //-----------------------adding teacher to single
	// sem---------------------------------------------
	// @PostMapping("/addteachertocourse")
	// public ResponseEntity<Modifysem> addsem(@RequestBody Modifysem sems ,
	// Semesters sem){
	//
